    ...
    <div className="container relative flex px-6 py-16 mx-auto">
        <div className="relative z-20 flex flex-col sm:w-2/3 lg:w-2/5">
            ...
            <div className="flex mt-8">
                ...
                <Link to="/travel" className="px-4 py-2 text-blue-500 uppercase bg-transparent border-2 border-blue-500 rounded-lg hover:bg-blue-500 hover:text-white text-md">
                    Rekomendasi Wisata
                </Link>
            </div>
        </div>
